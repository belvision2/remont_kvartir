...
BX.adminFormTools = {
	...
	_modified_file_onchange: function()
	{
		...
		else
		{
			...
			{
				var n = v[i].name || v[i];
				var p = Math.max(n.lastIndexOf('../../index.html'), n.lastIndexOf('\\'));
				if (p > 0)
...
BX.adminTabControl.prototype.ShowWarnings = function(form_name, warnings)
{
	...
	for(var i in warnings)
	{
		...
		img.src = '../panel/main/images_old/icon_warn.gif';
...
BX.adminTabControl.prototype.SaveSettings =  function(el)
{
	...
	var options_url = '../admin/user_options415a.html?lang='+BX.message('LANGUAGE_ID')+'&sessid=' + BX.bitrix_sessid();
...
BX.AdminFilter = function(filter_id, aRows)
{
	...
	this.DeleteFromBase = function(id)
	{
		...
		BX.ajax.post('../admin/filter_act.html', data, callback);
	...
	this.SaveOpenTab = function(id)
	{
		...
		BX.ajax.post('../admin/filter_act.html', data);
	};
