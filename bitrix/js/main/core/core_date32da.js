...
BX.CClockSelector.prototype.Show = function()
{
	if (!this.isReady)
	{
		...
		return BX.ajax.get('../bitrix/tools/clock_selector.html', {start_time: this.params.start_time, clock_id: this.CLOCK_ID, sessid: BX.bitrix_sessid()}, BX.delegate(this.Ready, this));
	}
